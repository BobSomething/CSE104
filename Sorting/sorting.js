...
clickRandom.addEventListener('click', settingUp);
...
speed.addEventListener('input', function() {currentSpeed = 10 - speed.value;});
...
//changing the description of the algorithm
function changeAlgo() {
...
//sleep function, because there is not built-in sleep function in JavaScript :(
function sleep(ms) {
